    ...
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li><a class="nav-link {{ active_route('frontend.discount-boxes.index') }}" href="{{ route('frontend.discount-boxes.index', ['status' => \App\Enums\StatusEnum::IN_PROGRESS->value]) }}">ScontaBOX in Corso</a></li>
