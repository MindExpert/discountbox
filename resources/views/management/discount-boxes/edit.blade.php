@extends('_layouts.app', [
    'title'           => __('discount_box.actions.edit_model'),
...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item"><a href="{{ route('management.discount-boxes.show', ['discountBox' => $discountBox->id]) }}">{{ $discountBox->label }}</a></li>
    <li class="breadcrumb-item active">@lang('discount_box.actions.edit')</li>
@endsection
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header border-info border-3">
                    <h4 class="card-title">@lang('discount_box.actions.edit_model')</h4>
                </div>
                <form class="ajax-form" method="POST"
                      action="{{ route('management.discount-boxes.update', ['discountBox' => $discountBox]) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control"
                                           name="name"
                                           id="name"
                                           placeholder="@lang('discount_box.fields.name')"
                                           value="{{ $discountBox->name }}"
                                    />
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number"
                                           class="form-control"
                                           name="price"
                                           id="price" placeholder="@lang('discount_box.fields.price')"
                                           value="{{ $discountBox->price }}"
                                    />
                                    <span class="invalid-feedback"></span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control select2" name="coupon_id" id="coupon_id"
                                        ...
                                        @if($discountBox->coupon)
                                            <option value="{{ $discountBox->coupon->id }}" selected>{{ $discountBox->coupon->label }}</option>
                                        @endif
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control"
                                           name="credits"
                                           id="credits"
                                           placeholder="@lang('discount_box.fields.credits')"
                                           value="{{ $discountBox->credits }}"
                                    />
                                    <span class="invalid-feedback"></span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-switch form-switch-lg mt-2 mb-3" dir="ltr">
                                    <input class="form-check-input" type="checkbox" id="highlighted" name="highlighted" value="1" @checked($discountBox->highlighted) />
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-switch form-switch-lg mt-2 mb-3" dir="ltr">
                                    <input class="form-check-input" type="checkbox" id="show_on_home" name="show_on_home" value="1" @checked($discountBox->show_on_home) />
                    ...
                    <div class="card-footer bg-success bg-opacity-10">
                        <div class="col-md-12 text-end">
                            <button type="submit" class="btn btn-outline-primary mr-1 submit-btn">
                                @lang('discount_box.actions.edit_model')<i class="fa fa-spinner fa-spin d-none"></i>
                            </button>
